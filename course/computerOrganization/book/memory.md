...
![圖、各種正反器](flop_flop.png)

## SR 正反器

正反器是可以用來儲存位元，是循序電路的基礎，以下是一個用 NAND 閘構成的正反器。

![圖、NAND 閘構成的正反器](nandLatch.png)
...
![圖、enLatch.vcd 的顯示圖形](enLatchWave.jpg)
...
![圖、delay.vcd 的顯示波型](delayGTKwave.jpg)
...
![圖、ptdLatch.vcd 的顯示圖形](ptdLatchWave.jpg)
...
![圖、在 GTKWave 中顯示的 ptdRegister.vcd 波型檔](GTKWavePtdRegister.jpg)
...
![圖、邊緣觸發的計數電路](ptdCounterCircuit.jpg)
...
![圖、在 GTKWave 中顯示的 ptdCounter.vcd 波型檔](GTKWavePtdCounter.jpg)
